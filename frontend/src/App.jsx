    ...
    <div className={`glass p-7 group card-hover relative overflow-hidden`}>
      <div className="relative z-10">
        <div className="flex justify-between items-start mb-4">
           ...
           {delta && (
             <span className={`text-[10px] font-black px-2 py-1 rounded-lg ${delta.includes('+') ? 'bg-emerald-500/10 text-emerald-500' : 'bg-rose-500/10 text-rose-500'}`}>
               {delta}
             </span>
           )}
        </div>
  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="grid grid-cols-5 gap-6">
        ...
        <StatCard label="Live Approvals" value={stats.approved} delta="+84%" subtext="Autonomous" color="emerald" icon={CheckCircle2} />
